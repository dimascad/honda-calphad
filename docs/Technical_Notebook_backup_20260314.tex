...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Year 2} (Andrew's group): Experimental tests with Al$_2$O$_3$. Some Cu reduction was observed, but Na$_2$S salt flux was more effective (95\% removal). Na$_2$S produces toxic H$_2$S gas, motivating the oxide approach.
...
Even without the Fe oxidation bonus, Cu incorporation into the spinel is thermodynamically driven. After activity correction ($n_{\text{Cu}} = 1$, penalty $= +54.9$ kJ), the Cu-capture component becomes $-45.7 + 54.9 = +9.2$ kJ, which is marginal. But the full reaction remains robust at $-57.0$ kJ because the Fe oxidation energy is ``free'' (Fe is already being oxidized in the steelmaking slag).
